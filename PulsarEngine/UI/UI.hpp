...
enum PulPageId {
    ...
    PULPAGE_MAX = PULPAGE_REGION - PULPAGE_INITIAL + 1
};
...
enum BMG {
    ...
    BMG_TRANSMISSION_SELECT = 0x2836,
    BMG_INSIDE_TRANSMISSION = 0x2837,
    BMG_OUTSIDE_TRANSMISSION = 0x2838,
    BMG_INSIDE_TRANSMISSION_BOTTOM = 0x2839,
    BMG_OUTSIDE_TRANSMISSION_BOTTOM = 0x283a,
    ...
    // Cause and Effect
    BMG_CAUSE_EFFECT_TOGGLE = 0x2920,
    BMG_CAUSE_EFFECT_TOGGLE_DESCRIPTION = 0x2921,
